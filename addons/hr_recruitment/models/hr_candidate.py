    ...
    def _inverse_partner_email(self):
        for candidate in self:
            ...
            if not candidate.partner_id:
                ...
                candidate_vals = f"{candidate.partner_name} {candidate.email_from}"
                candidate.partner_id = self.env['res.partner'].with_context(default_lang=self.env.lang)\
                    .find_or_create(candidate_vals)
