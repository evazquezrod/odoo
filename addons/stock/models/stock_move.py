...
class StockMove(models.Model):
    ...
    @api.depends('name', 'picking_id.name', 'scrap_id.name', 'location_dest_usage')
    def _compute_reference(self):
        for move in self:
            move.reference = move.scrap_id.name if move.location_dest_usage == 'inventory' else move.picking_id.name or move.name
