...
import { PassKeyIdentityCheckFormController } from "../src/views/auth_passkey_identity_check_form_view";
    ...
    steps: () => [
        {
            ...
            trigger: 'body',
            run: () => {
                PassKeyIdentityCheckFormController.prototype.PASSKEY_TEST_AUTH = {
