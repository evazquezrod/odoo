        ...
        def get_section(line):
            ...
            if is_inv:
                ...
                if gst_treatment == 'overseas':
                    if tags_have_categ(tags, 'export'):
                        return 'sale_exp_wp'
                ...
                if gst_treatment == 'special_economic_zone':
                    if tags_have_categ(tags, 'export'):
                        ...
                        return 'sale_sez_wop'
                # Deemed export
                if gst_treatment == 'deemed_export' and tags_have_categ(tags, 'export'):
