...
class TestPortalControllers(TestPortal):
    ...
    def test_portal_avatar(self):
        ...
        self.assertIn(
            f'filename="{portal_partner.name}.svg"', response.headers.get("Content-Disposition", "")
        )
        ...
        self.assertIn(
            "filename=placeholder.png", placeholder_response.headers.get("Content-Disposition", "")
        )
        ...
        self.assertIn(
            "filename=placeholder.png", no_token_response.headers.get("Content-Disposition", "")
        )
