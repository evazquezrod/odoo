...
function addChild2(tree, child) {
    if (
        child.type === "connector" &&
        !child.negate &&
        (child.value === tree.value || child.children.length <= 1)
    ) {
