    ...
    def dispatch(self, endpoint, args):
        ...
        if self.request.httprequest.content_length:
            try:
                ...
                # We don't need anything else than json object at the
                # moment but we are open to discuss supporting the other
                # data types. Reach us if you have a use case!
                raise BadRequest("could not parse the body as a json object") from exc
        if self.request.db:
