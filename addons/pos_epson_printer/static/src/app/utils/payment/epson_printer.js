...
const EPSON_ERROR_STATUS_CODES = {
    251854870: "EPTR_PAPER_NEAR_END",
    252444700: "EPTR_REC_EMPTY",
    252641308: "EPTR_REC_EMPTY",
};
...
export class EpsonPrinter extends BasePrinter {
    ...
    getResultsError(printResult) {
        ...
        let message = "";
        if (EPSON_ERROR_STATUS_CODES[errorStatus] === "EPTR_REC_EMPTY") {
            message += _t("It seems that the printer runs out of paper.");
        } else if (EPSON_ERROR_STATUS_CODES[errorStatus] === "EPTR_PAPER_NEAR_END") {
