...
class ResConfigSettings(models.TransientModel):
    ...
    pos_self_ordering_image_home_ids = fields.Attachments(related="pos_config_id.self_ordering_image_home_ids", readonly=False)
    pos_self_ordering_image_background_ids = fields.Attachments(related="pos_config_id.self_ordering_image_background_ids", readonly=False)
