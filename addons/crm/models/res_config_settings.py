...
class ResConfigSettings(models.TransientModel):
    ...
    module_crm_markethub = fields.Boolean("Enable this option to integrate your marketplace accounts and automatically capture leads generated from your ad campaigns.")
