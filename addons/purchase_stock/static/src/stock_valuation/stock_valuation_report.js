...
patch(StockValuationReport.prototype, {
    defineInitialState() {
        ...
        initialState.displayNotInvoicedReceivedGoods = false;
        return initialState;
    },
    ...
    get notInvoicedReceivedValuation() {
        return this.formatMonetary(this.data.not_invoiced_received_goods.total);
    },
    ...
    toggleNotInvoicedReceivedGoodsFold() {
        this.state.displayNotInvoicedReceivedGoods = !this.state.displayNotInvoicedReceivedGoods;
    }
});