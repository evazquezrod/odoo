...
class IrAttachment(models.Model):
    ...
    def _has_attachments_ownership(self, attachment_tokens):
        ...
        def _is_attachment_owned(attachment, token):
        ...
        if all(_is_attachment_owned(att, tok) for att, tok in zip(self, attachment_tokens)):
            has_ownership = True
    ...
    def _get_store_attachment_ownership_fields(self):
        return [Store.Attr("attachment_ownership", lambda a: a._attachment_ownership_access_token())]
    ...
    def _attachment_ownership_access_token(self):
