...
class TestMessageController(HttpCaseWithUserDemo):
    ...
    def test_channel_message_attachments(self):
            ...
            data=json.dumps(
                {
                    "params": {
                        ...
                        "attachment_tokens": [
                            self.attachments[0]._attachment_ownership_access_token()
                        ],
                    },
                }
            ),
        ...
        self.assertEqual(
            ...
            [
                {
                    "attachment_ownership": attachment._attachment_ownership_access_token(),
                    "checksum": False,
            ...
            data=json.dumps(
                {
                    "params": {
                        ...
                        "attachment_ids": [self.attachments[1].id],
                        "attachment_tokens": [
                            self.attachments[1]._attachment_ownership_access_token()
                        ],
                    },
                }
            ),
