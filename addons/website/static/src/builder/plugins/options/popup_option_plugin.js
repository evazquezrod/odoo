...
export class MoveBlockAction extends BuilderAction {
    ...
    isApplied({ editingElement, value }) {
        return editingElement.closest("#o_shared_blocks")
            ? (editingElement.dataset.showOnSpecificPages === "true" ? value === "specificPages" : value === "allPages")
            : value === "currentPage";
    }
    apply({ editingElement, value }) {
        const selector = 
            (value === "allPages" || value === "specificPages") ? "#o_shared_blocks" : "main .oe_structure.o_editable";
