...
class ProductXmlFeed(Controller):
    ...
    @route(['/gmc.xml', '/gmc-<pricelist_name_ilike>.xml'], type='http', auth='public', website=True, sitemap=False)
    ...
    @route(['/meta.xml', '/meta-<pricelist_name_ilike>.xml'], type='http', auth='public', website=True, sitemap=False)
