...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _post_load_demo_data(self, company=False):
        ...
        demo_bank_statement_2 = self.ref('demo_bank_statement_2', raise_if_not_found=False)
        if demo_bank_statement_2:
            ...
            demo_bank_statement_2.line_ids[0].line_ids[1]['account_id'] = current_year_earnings_account.id
