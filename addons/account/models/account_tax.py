...
class AccountTax(models.Model):
    ...
    def _add_tax_details_in_base_line(self, base_line, company, rounding_method=None):
        ...
        :param BaseLine base_line:               A base line generated by '_prepare_base_line_for_taxes_computation'.
        :param res.company company:     The company owning the base line.
        :param str rounding_method:     The rounding method to be used. If not specified, it will be taken from the company.
        """
        # foo = base_line["price_unit"] + 'asdf'
