...
class HrEmployee(models.Model):
    ...
    car_ids = fields.One2many(
        ...
        groups="fleet.fleet_group_manager,hr.group_hr_employee_manager",
    )
    license_plate = fields.Char(compute="_compute_license_plate", search="_search_license_plate", groups="hr.group_hr_employee_manager")
