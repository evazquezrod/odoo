...
class TestMrpOrder(TestMrpCommon):
    ...
    # adapter pour passer par lot_producing_ids ou supprimer le test ?
    ...
    def test_batch_production_01(self):
        ...
        self.assertRecordValues(productions.lot_producing_ids, [
            {'name': "00001"},
            {'name': "00002"},
            {'name': "00003"},
            {'name': "00004"},
    ...
    def test_batch_production_02(self):
        ...
        for i in range(1, 5):
            ...
            self.assertEqual(production.lot_producing_ids.name, f"0000{i}")
    ...
    def test_batch_production_03(self):
        ...
        mo_form.bom_id = self.env['mrp.bom'].create({
            ...
            'type': 'normal',
            'bom_line_ids': [
                Command.create({'product_id': self.product_2.id, 'product_qty': 2}),
        ...
        self.assertEqual(production_1.lot_producing_ids.name, "00001")
