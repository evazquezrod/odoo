"""The :mod:`odoo.addons.base_paper_muncher.engine.utils.io_with_timeout.posix.communications`
...
from odoo.addons.base_paper_muncher.engine.io_with_timeout.common import (
    remaining_time,
)
