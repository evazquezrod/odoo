...
class ProjectTask(models.Model):
    ...
    @api.depends('allow_billable', 'sale_line_id')
    def _compute_partner_id(self):
        ...
        for task in billable_task:
            if not task.partner_id and task.sale_line_id:
                task.partner_id = task.sale_line_id.order_partner_id
