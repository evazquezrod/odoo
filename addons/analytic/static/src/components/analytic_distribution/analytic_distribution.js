...
export class AnalyticDistribution extends Component {
    ...
    onWindowClick(ev) {
        ...
        Dropdown should be closed only if all these conditions are true:
            ...
            - Either:
                - The click is not inside an active modal without a list/kanban view (search more modal)
        ...
        */
        ...
        if (this.isDropdownOpen
            ...
            && (!ev.target.closest(selectors.join(",")) || document.querySelector(".modal:not(.o_inactive_modal)").contains(this.widgetRef.el))
