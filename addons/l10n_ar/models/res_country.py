...
class ResCountry(models.Model):
    ...
    l10n_ar_natural_vat = fields.Char(
        'Natural Person VAT', help="Generic VAT number defined by AFIP in order to recognize partners from"
        " this country that are natural persons")
    l10n_ar_legal_entity_vat = fields.Char(
        'Legal Entity VAT', help="Generic VAT number defined by AFIP in order to recognize partners from this"
        " country that are legal entity")
    l10n_ar_other_vat = fields.Char(
        'Other VAT', help="Generic VAT number defined by AFIP in order to recognize partners from this"
