...
%(contracts)s""",
    ...
    def write(self, values):
        ...
        # Any change in approved(validate) stage by leave officer->create new resource.calendar.leaves & update meeting
        if 'state' not in values and any(key in values for key in keys_to_check):
