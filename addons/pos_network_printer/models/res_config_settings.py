...
class ResConfigSettings(models.TransientModel):
    ...
    @api.depends('pos_nw_printer_ip', 'pos_other_devices')
    ...
    def _is_cashdrawer_displayed(self, res_config):
        return super()._is_cashdrawer_displayed(res_config) or (res_config.pos_other_devices and bool(res_config.pos_nw_printer_ip))
    ...
    def _compute_pos_nw_printer_ip(self):
        for res_config in self:
            if not res_config.pos_other_devices:
                ...
                res_config.pos_nw_printer_ip = res_config.pos_config_id.epson_printer_ip
