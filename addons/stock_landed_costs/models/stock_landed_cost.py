    ...
    def button_validate(self):
        ...
        for cost in self:
            ...
            for line in cost.valuation_adjustment_lines.filtered(lambda line: line.move_id):
                ...
                remaining_qty = line.move_id._get_remaining_qty()
            ...
            if cost.account_move_id:
                move._post()
            cost.valuation_adjustment_lines.product_id._update_standard_price()
        return True
...
class StockLandedCostLines(models.Model):
    ...
    def onchange_product_id(self):
        ...
        self.account_id = accounts_data['stock_valuation']
...
class StockValuationAdjustmentLines(models.Model):
    ...
    def _create_accounting_entries(self, remaining_qty):
        ...
        credit_account_id = self.cost_line_id.account_id.id or cost_product._get_product_accounts()['stock_expense'].id
