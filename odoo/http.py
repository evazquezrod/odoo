...
class Request:
    ...
    @property
    def context(self):
        warnings.warn("Since 19.0, use request.env.context directly", DeprecationWarning)
    ...
    @property
    def uid(self):
        warnings.warn("Since 19.0, use request.env.uid directly", DeprecationWarning)
        return self.env.uid
    ...
    @property
    def cr(self):
        warnings.warn("Since 19.0, use request.env.cr directly", DeprecationWarning)
        return self.env.cr
