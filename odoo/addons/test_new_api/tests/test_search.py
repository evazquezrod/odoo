    ...
    def test_not_or_autojoined_many2one_with_subfield(self):
        ...
        with self.assertQueries(["""
            ...
            LEFT JOIN "res_partner" AS "test_new_api_multi__partner"
                ON ("test_new_api_multi"."partner" = "test_new_api_multi__partner"."id")
            WHERE (
                "test_new_api_multi"."partner" IS NULL OR
                ((
                    "test_new_api_multi__partner"."name" LIKE %s
                    OR "test_new_api_multi__partner"."phone" LIKE %s
                )) IS NOT TRUE
    ...
    def test_and_one2many_with_subfield(self):
        with self.assertQueries(["""
            ...
            WHERE ("test_new_api_multi"."id" IN (
                ...
                WHERE (
                    "test_new_api_multi_line"."multi" IS NOT NULL
                    AND "test_new_api_multi_line"."name" LIKE %s
                )
        ...
        with self.assertQueries(["""
            ...
            WHERE "test_new_api_multi"."id" IN (
                ...
                WHERE (
                    "test_new_api_multi_line"."multi" IS NOT NULL
                    AND (
                        "test_new_api_multi_line"."name" LIKE %s
...
class TestSearchRelated(TransactionCase):
    ...
    def test_related_simple(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND "test_new_api_related__foo_id"."name" IN %s)
    ...
    def test_related_many2one(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                ...
                AND "test_new_api_related__foo_id"."bar_id" IN %s
            )
            AND "test_new_api_related"."id" < %s
            ORDER BY "test_new_api_related"."id"
        """]):
        ...
        with self.assertQueries(["""
            ...
            LEFT JOIN "test_new_api_related_foo" AS "test_new_api_related__foo_id"
                ON ("test_new_api_related"."foo_id" = "test_new_api_related__foo_id"."id")
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL
                AND "test_new_api_related__foo_id"."bar_id" IN (
                    SELECT "test_new_api_related_bar"."id"
                    FROM "test_new_api_related_bar"
                    WHERE "test_new_api_related_bar"."name" IN %s
                    AND "test_new_api_related_bar"."id" < %s
    ...
    def test_related_many2many(self):
        ...
        with self.assertQueries(["""
            ...
            LEFT JOIN "test_new_api_related_foo" AS "test_new_api_related__foo_id"
                ON ("test_new_api_related"."foo_id" = "test_new_api_related__foo_id"."id")
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND EXISTS (
                SELECT 1
    ...
    def test_related_one2many(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE "test_new_api_related"."foo_id" IN (
                ...
                WHERE "test_new_api_related_foo"."id" IN (
                    SELECT "test_new_api_related"."foo_id"
                    FROM "test_new_api_related"
                    WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND "test_new_api_related"."name" IN %s)
                    AND "test_new_api_related"."id" < %s
                )
                AND "test_new_api_related_foo"."id" < %s
            )
        ...
        with self.assertQueries(["""
            ...
            LEFT JOIN "test_new_api_related_foo" AS "test_new_api_related__foo_id"
                ON ("test_new_api_related"."foo_id" = "test_new_api_related__foo_id"."id")
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND "test_new_api_related__foo_id"."id" IN (
                SELECT "test_new_api_related"."foo_id"
                FROM "test_new_api_related"
                WHERE "test_new_api_related"."id" IN %s
                AND "test_new_api_related"."foo_id" IS NOT NULL
    ...
    def test_related_binary(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related"."foo_id" IS NOT NULL
                AND "test_new_api_related__foo_id"."id" IN (
                    SELECT res_id FROM ir_attachment WHERE res_model = %s AND res_field = %s
                )
            )
            AND "test_new_api_related"."id" < %s
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related"."foo_id" IS NOT NULL
                AND "test_new_api_related__foo_id"."binary_bin" IS NOT NULL
            )
            AND "test_new_api_related"."id" < %s
            ORDER BY "test_new_api_related"."id"
        """]):
    ...
    def test_related_multi(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND (
                "test_new_api_related__foo_id"."bar_id" IS NOT NULL
                AND "test_new_api_related__foo_id__bar_id"."name" IN %s
            ))
            AND "test_new_api_related"."id" < %s
            ORDER BY "test_new_api_related"."id"
        """]):
    ...
    def test_related_null(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related"."foo_id" IS NULL
                OR ("test_new_api_related__foo_id"."name" IN %s) IS NOT TRUE
            )
            ORDER BY "test_new_api_related"."id"
        """]):
            model.search([('foo_name_sudo', '!=', 'a')])
        ...
        with self.assertQueries(["""
            ...
            LEFT JOIN "test_new_api_related_foo" AS "test_new_api_related__foo_id"
                ON ("test_new_api_related"."foo_id" = "test_new_api_related__foo_id"."id")
            WHERE ("test_new_api_related"."foo_id" IS NULL OR (
                "test_new_api_related"."foo_id" IS NOT NULL AND (
        ...
        with self.assertQueries(["""
            ...
            WHERE ("test_new_api_related"."foo_id" IS NULL OR (
                "test_new_api_related"."foo_id" IS NOT NULL AND (
                    "test_new_api_related__foo_id"."bar_id" IS NULL
                    OR ("test_new_api_related__foo_id"."bar_id" IS NOT NULL AND (
        ...
        with self.assertQueries(["""
            ...
            WHERE ("test_new_api_related"."foo_id" IS NOT NULL AND (
                "test_new_api_related__foo_id"."bar_id" IS NOT NULL
                AND "test_new_api_related__foo_id__bar_id"."name" NOT IN %s
            ))
            ORDER BY "test_new_api_related"."id"
        """]):
            model.search([('foo_bar_name_sudo', '!=', False)])
    ...
    def test_related_inherited(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related_inherits__base_id"."foo_id" IS NOT NULL
                AND "test_new_api_related_inherits__base_id__foo_id"."name" IN %s
            )
            AND "test_new_api_related_inherits__base_id"."id" < %s
            ORDER BY "test_new_api_related_inherits"."id"
        """]):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related_inherits__base_id"."foo_id" IS NOT NULL AND (
                    "test_new_api_related_inherits__base_id__foo_id"."bar_id" IS NOT NULL
                    AND "test_new_api_related_inherits__base_id__foo_id__bar_id"."name" IN %s
                )
            )
            AND "test_new_api_related_inherits__base_id"."id" < %s
            ORDER BY "test_new_api_related_inherits"."id"
...
class TestSearchAny(TransactionCase):
    ...
    def test_many2one_any(self):
        ...
        with self.assertQueries(["""
            ...
            WHERE (
                "test_new_api_related"."foo_id" IS NOT NULL
                AND "test_new_api_related__foo_id"."name" IN %s
            ) AND "test_new_api_related"."id" < %s
            ORDER BY "test_new_api_related"."id"
        """]):
            model.search(Domain('foo_id', 'any*', Domain('name', '=', 'a')))
...
class TestNonIntId(TransactionCase):
    ...
    def test_query_non_int_read_group(self):
        result = self.env['test_new_api.view.str.id'].formatted_read_group([], ['name'], ['__count'])
        self.assertEqual(result, [{'name': 'test', '__count': 1, '__extra_domain': [('name', '=', 'test')]}])
        result = self.env['test_new_api.view.str.id'].formatted_read_group([], [], ['name:count'])
