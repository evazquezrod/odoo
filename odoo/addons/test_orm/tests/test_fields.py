...
class TestFields(TransactionCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_21_date_datetime_helpers(self):
        ...
        _date = fields.Date.from_string("2077-10-23")  # noqa: RUF052
        _datetime = fields.Datetime.from_string("2077-10-23 09:42:00")  # noqa: RUF052
...
class TestFieldFilterNotEqual(TransactionCase):
    def test_filter_not_equal_char(self):
        ...
        self.assertFalse(field._filter_not_equal(record, 'Foo'))
        self.assertTrue(field._filter_not_equal(record, 'Bar'))
    ...
    def test_filter_not_equal_one2many(self):
        ...
        self.assertFalse(field._filter_not_equal(record, []))
        self.assertTrue(field._filter_not_equal(record, [Command.create({})]))
        self.assertFalse(field._filter_not_equal(record, [Command.update(line1.id, {})]))
        self.assertFalse(field._filter_not_equal(record, [Command.update(line1.id, {'name': '1'})]))
        self.assertTrue(field._filter_not_equal(record, [Command.update(line1.id, {'name': '3'})]))
        self.assertTrue(field._filter_not_equal(record, [Command.delete(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.unlink(line1.id)]))
        self.assertFalse(field._filter_not_equal(record, [Command.link(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line3.id)]))
        self.assertFalse(field._filter_not_equal(line1, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.clear()]))
        self.assertFalse(field._filter_not_equal(record, [Command.set([line1.id, line2.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id, line3.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line3.id])]))
        ...
        self.assertFalse(field._filter_not_equal(record, []))
        self.assertTrue(field._filter_not_equal(record, [Command.create({})]))
        self.assertTrue(field._filter_not_equal(record, [Command.update(line1.id, {})]))
        self.assertTrue(field._filter_not_equal(record, [Command.update(line1.id, {'name': '1'})]))
        self.assertTrue(field._filter_not_equal(record, [Command.update(line1.id, {'name': '3'})]))
        self.assertTrue(field._filter_not_equal(record, [Command.delete(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.unlink(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line3.id)]))
        self.assertTrue(field._filter_not_equal(line1, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id, line3.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line3.id])]))
    ...
    def test_filter_not_equal_many2many(self):
        ...
        self.assertTrue(field._filter_not_equal(record, [Command.delete(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.unlink(line1.id)]))
        self.assertFalse(field._filter_not_equal(record, [Command.unlink(line3.id)]))
        self.assertFalse(field._filter_not_equal(record, [Command.link(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line3.id)]))
        self.assertFalse(field._filter_not_equal(record0, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.clear()]))
        self.assertFalse(field._filter_not_equal(record, [Command.set([line1.id, line2.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id, line3.id])]))
        ...
        self.assertTrue(field._filter_not_equal(record, [Command.delete(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.unlink(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.unlink(line3.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line1.id)]))
        self.assertTrue(field._filter_not_equal(record, [Command.link(line3.id)]))
        self.assertTrue(field._filter_not_equal(record0, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.clear()]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id])]))
        self.assertTrue(field._filter_not_equal(record, [Command.set([line1.id, line2.id, line3.id])]))
